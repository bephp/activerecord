...
var_dump($contact->in('id', array(1,2,3,4,5,6))->isnotnull('id')->order('id desc', 'name asc')->find());
// build sql: SELECT * FROM contact  WHERE id IN (1,2,3,4,5,6) AND id IS NOT NULL     ORDER BY id desc, name asc   limit 1 
